...
def forwards(apps, schema_editor):
    from trainees.semester_utils import compute_semester_for_trainee
...
class Migration(migrations.Migration):
    dependencies = [
        ('trainees', '0021_promotion_dates_optional_and_schedule'),
        ('trainees', '0021_promotion_schedule_from_following_promotions'),
    ]
